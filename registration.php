...
include 'includes/googleAuth.php';
...
<body>
    <form action="includes/mail.php" class="form" method="post">
        <div class="wrapper">
            ...
            <a href="<?php echo $url ?>" class="g-auth"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 48 48">
